...
train_dataset = FoodDataset(train_dict, 'train', train_transform_dict, transform=train_transforms)
val_dataset = FoodDataset(val_dict, 'val', val_transform_dict, transform=valtest_transforms)
test_dataset = FoodDataset(test_dict, 'test', test_transform_dict, transform=valtest_transforms)
